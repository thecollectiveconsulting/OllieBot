...
namespace Ollie
{
    ...
    public class AuthenticationConfig
    {
        ...
        /// <summary>
        /// Log analytics API endpoint, could be public Azure (default) or a Sovereign cloud (US government, etc ...)
        /// </summary>
        public string LogAnalyticsApiUrl { get; set; } = "https://api.loganalytics.io/";

        /// <summary>
        /// Log analytics API endpoint, could be public Azure (default) or a Sovereign cloud (US government, etc ...)
        /// </summary>
        public string SentinelApiUrl { get; set; } = "https://api.loganalytics.io/";
        ...
        public string SentinelApiVersion { get; set; }
